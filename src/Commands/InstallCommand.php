...
class InstallCommand extends Command
{
    ...
    public function handle(): void
    {
        ...
        $this->confirm('Did you set the table_prefix in config/statamic/eloquent-driver.php to "statamic_"?');
        ...
        if ($this->confirm('Would you like to configure a multisite?')) {
            $this->call('statamic:multisite');
        }

        if ($this->confirm('Would you like to publish Collections, Blueprints and Fieldsets?')) {
            $this->call('vendor:publish', [
        ...
        if ($this->confirm('Would you like views?')) {
            $this->call('vendor:publish', [
                '--provider' => 'Rapidez\Statamic\RapidezStatamicServiceProvider',
                '--tag' => 'views',
            ]);
        ...
        if ($this->confirm('Would you like to make a user?')) {
